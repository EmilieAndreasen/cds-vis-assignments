...
def build_model(train_data):
    ...
    headModel = Dense(512, activation="relu")(headModel) #change to 128 + another dense layer with 10 (?) to try and change the architecture
...
def main():
    ...
    lr_schedule = ExponentialDecay(initial_learning_rate=0.01, decay_steps=10000, decay_rate=0.9) #perhaps change this to not be included (i.e., no learning schedule)
    sgd = SGD(learning_rate=lr_schedule) #change to vanilla + try with tf.keras Adam (see notebook)
